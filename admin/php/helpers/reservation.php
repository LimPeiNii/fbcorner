            ...
            if (empty($_POST['edit_reservation_id'])){
                ...
                if ($_POST['ongoing'] == '1'){
                    ...
                    if ($ongoing_reservations){
                        ...
                        $result = getCustomerOrders($connection, $cus_id, ['not_statuses' => ['Completed', 'Cancelled', 'Disabled', 'Upcoming'], 'rest_id' => $_SESSION['login_rest_id'], 'not_order_id' => $preorders[0]['order_id']]);
        ...
        if (isset($_GET['reservation_id'])){
            ...
            if ($order_info){
                ...
                if ($remarks == 'Ongoing' && $order_info[0]['status'] == 'Upcoming'){
                    $sql2 .= ", status = 'Pending'";
                } elseif ($remarks != 'Ongoing' && $order_info[0]['status'] != 'Upcoming') {
            ...
            sendmail($customer_email, $restaurant_name . ' - Reservation ' . $_GET['reservation_id'] . ' Updated', $email_body, $success_msg);
            ...
            $success_msg = sendmail($restaurant_email, $restaurant_name . ' - Reservation ' . $_GET['reservation_id'] . ' Updated', $email_body, $success_msg);
        } else {
            ...
            sendmail($customer_email, $restaurant_name . ' - Reservation ' . $inserted_id, $email_body, $success_msg);
            ...
            $success_msg = sendmail($restaurant_email, $restaurant_name . ' - Reservation ' . $inserted_id, $email_body, $success_msg);
        }
