<?php
    ...
    if (isset($_POST['submit_form_food_menu'])){
        ...
        if (isset($_GET['item_id'])){
            ...
            $sql = "INSERT INTO `food_item`(rest_id, item_code, item_name, `description`, category_id, price, ingredients, `status`, unavailable_condition) VALUES ('" . $_SESSION['login_rest_id'] . "','" . $item_code . "','" .  $item_name . "','" .  $description . "','" .  $category_id . "','" .  $price . "','" .  json_encode($ingredients) . "','" . $final_status . "', '" . json_encode($unavailable_condition) . "')";
