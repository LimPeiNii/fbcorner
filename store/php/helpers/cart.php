<?php
    ...
    if (isset($_POST['checkout_cart'])){
        ...
        if ($results){
            ...
            if (!isset($promotions)){
                $sql3 = "INSERT INTO `order`(rest_id, cus_id, `table_id`, pickup_time, item_quantity, voucher_id, `status`, additional_notes, remarks) VALUES ('" . $_POST['rest_id'] . "','" . $_SESSION['login_cus_id'] . "','" . $_POST['table_id'] . "'," . $_POST['pickup_time'] . ",'" .  $item_quantity . "','" . $voucher_id . "','Pending','" . $_POST['additional_notes'] . "','')";
            } else {
                $sql3 = "INSERT INTO `order`(rest_id, cus_id, `table_id`, pickup_time, item_quantity, voucher_id, `status`, additional_notes, remarks, promotions) VALUES ('" . $_POST['rest_id'] . "','" . $_SESSION['login_cus_id'] . "','" . $_POST['table_id'] . "'," . $_POST['pickup_time'] . ",'" .  $item_quantity . "','" . $voucher_id . "','Pending','" . $_POST['additional_notes'] . "','','" . $promotions . "')";
            }
