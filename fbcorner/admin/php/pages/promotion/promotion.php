    ...
    <div class="side-bar-body">
        ...
        <div class="content p-4">
            <?php if ((int)$has_permission['has_permission']){ ?>
                ...
                <button type="button" class="btn bg-info float-end" data-bs-toggle="tooltip" data-bs-placement="top" title="Refresh Redemption Chances" id="reset-redemption"><i class="fas fa-sync-alt font-size-20 text-white m-0 p-0" style="line-height: 30px;"></i></button>
            ...
            $(document).ready(function() {
                ...
                $('#reset-redemption').click(function () {
                    ...
                    if (promo_ids.length > 0){
                        <?php if ((int)$has_modify_permission['has_permission']){ ?>
                            if (confirm("Are you sure you want to refresh the redemption chances of this promotional code(s) for all customers?")){
                                $.ajax({ 
                                    url: '../../helpers/promotion.php',
