<?php
    ...
    if (isset($new_name)){
        $sql2 = "INSERT INTO restaurant(rest_id, rest_name, owner_name, owner_contact_num, owner_email, contact_number, email, `address`, rest_profile, documents, `description`, additional_notes) VALUES ('" . $new_id . "','" .  $rest_name . "','" . $owner_name . "','" . $contact_num . "','','','" . $email . "','" . $address . "','" . $new_name . "','" . $documents . "','','')";
        $result = $connection->query($sql2);
    }
    else {       
        $sql2 = "INSERT INTO restaurant(rest_id, rest_name, owner_name, owner_contact_num, owner_email, contact_number, email, `address`, documents, `description`, additional_notes) VALUES ('" . $new_id . "','" .  $rest_name . "','" . $owner_name . "','" . $contact_num . "','','','" . $email . "','" . $address . "','" . $documents . "','','')";
        $result = $connection->query($sql2);
    }
