<?php
    ...
    if (isset($_POST['submit_form_order'])){
        ...
        if (isset($_GET['order_id'])){
            ...
            $success_msg = sendmail($customer_email, $restaurant_name . ' - Order ' . $_GET['order_id'] . ' Update', $email_body, $success_msg);
            ...
            if (!in_array($restaurant_email, ['veganFood@gmail.com', 'thewestern@gmail.com', 'hotchicken@gmail.com', 'thejapanese@gmail.com'])){
                sendmail($restaurant_email, $restaurant_name . ' - Order ' . $_GET['order_id'] . ' Update', $email_body, $success_msg);
            }
        } else {
            if (!empty($promotions)){
            ...
            $success_msg = sendmail($customer_email, $restaurant_name . ' - Order ' . $inserted_id, $email_body, $success_msg);
            ...
            if (!in_array($restaurant_email, ['veganFood@gmail.com', 'thewestern@gmail.com', 'hotchicken@gmail.com', 'thejapanese@gmail.com'])){
                sendmail($restaurant_email, $restaurant_name . ' - Order ' . $inserted_id, $email_body, $success_msg);
            }
        }
    ...
    if (isset($_POST['submit_form_preorder'])){
        ...
        if (isset($_GET['order_id'])){
            ...
            $success_msg = sendmail($customer_email, $restaurant_name . ' - Reservation ' . $reservation_id . ' Updated', $email_body, $success_msg);
            ...
            if (!in_array($restaurant_email, ['veganFood@gmail.com', 'thewestern@gmail.com', 'hotchicken@gmail.com', 'thejapanese@gmail.com'])){
                sendmail($restaurant_email, $restaurant_name . ' - Reservation ' . $reservation_id . ' Updated', $email_body, $success_msg);
            }
        } else {
            ...
            $success_msg = sendmail($customer_email, $restaurant_name . ' - Reservation ' . $reservation_info['reservation_id'] . ' Updated', $email_body, $success_msg);
            ...
            if (!in_array($restaurant_email, ['veganFood@gmail.com', 'thewestern@gmail.com', 'hotchicken@gmail.com', 'thejapanese@gmail.com'])){
                sendmail($restaurant_email, $restaurant_name . ' - Reservation ' . $reservation_info['reservation_id'] . ' Updated', $email_body, $success_msg);
            }
        }
