<?php
    ...
    if (isset($_POST['reservation_submit'])){
        ...
        $sql = "INSERT INTO reservation(cus_id, rest_id, `date`, time_slot_id, table_id, additional_notes, `status`, remarks) VALUES ('" . $_SESSION['login_cus_id'] . "','" .  $_POST['restaurant'] . "','" . $_POST['date'] . "','" . json_encode($_POST['time_slot_ids']) . "','" . $assign_table_id . "','" . $_POST['additional_request'] . "','1', '')";
        ...
        if (isset($_POST['preorder_food_qty'])){
            ...
            $sql3 = "INSERT INTO `order`(rest_id, cus_id, table_id, item_quantity, voucher_id, reservation_id, `status`, additional_notes, remarks) VALUES ('" . $_POST['restaurant'] . "','" .  $_SESSION['login_cus_id'] . "','" . $assign_table_id . "','" . json_encode($_POST['preorder_food_qty']) . "','" . $voucher_id . "','" . $reservation_id . "','Upcoming' ,'','')";
