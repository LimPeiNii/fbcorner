            ...
            <?php foreach ($food_menu_items as $key => $categories) { ?>
                ...
                <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 mt-0 px-4 pb-5">
                    <?php foreach ($categories as $food_menu_item) { ?>
                        ...
                        <a href="food_profile.php?food_item_id=<?=$food_menu_item['item_id']?>" target="_blank" class="d-flex">
                        ...
                        <?php } ?>
                            <div class="card h-100 shadow">
                                <img height="250" src="../../../../admin/uploads/food_menu_photo/<?=$food_menu_item['image']?>" style="object-fit: cover;" class="card-img-top">
                                <div class="card-body">
